...
function getPasswords() {
  ...
  loadinglabel.innerHTML = gettranslate("search_documents")+"...";
  var xhr = new XMLHttpRequest();
  var url = host+"/iSenhasBuscarDocsV4";
  if(development) url = host+"/iSenhasBuscarDocsV4DEV";
  ...
  xhr.onreadystatechange = async function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      if (records.length == 0) {
        ...
        todasSenhas = records;
        loadinglabel.innerHTML = gettranslate("search_documents")+": " + todasSenhas.length;
        var permission = getCookie("permission");
        if(permission == "ADMIN" || permission == "USER"){
          getUsers();
        } else getVaults()
    ...
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      if (records.length == 0) {
        ...
        for(var i=0;i<records.length;i++){
          ...
          records[i].permission = records[i].permission
          records[i].recordName = records[i].recordName
          records[i].recordChangeTag = records[i].recordChangeTag
        }
...
function getShared() {
  ...
  xhr.send(""+JSON.stringify({"type":"doc"}));
}
...
function reloadTable(){
    $('#table-body').empty();
    selectedRows = [];
    document.getElementById("title").innerHTML =gettranslate("documents") +" ("+todasSenhas.length+") ";
    var permission = getCookie("permission");
    var favorites = []
    var others = []
...
async function addSenha() {
  ...
  loadinglabel.innerHTML = gettranslate("add_document")+"...";
  var xhr = new XMLHttpRequest();
  var url = host+"/iSenhasAddDocV4";
  if(development) url = host+"/iSenhasAddDocV4DEV";
  xhr.open("POST", url, true);
  xhr.setRequestHeader("Content-Type", "application/json");
  xhr.setRequestHeader('Access-Control-Allow-Origin', '*');
  xhr.setRequestHeader('authorization', token);
...
function excluirSenhas() {
  ...
  loadinglabel.innerHTML = gettranslate("remove_document")+": "+enviado;
  var xhr = new XMLHttpRequest();
...
function edit(id){
  ...
  if(password.fields.admin){
    ...
    let translator = gettranslate("favorite_document")
    if(password.sharedDesc == null){
...
async function editSenha() {
  ...
  loadinglabel.innerHTML = gettranslate("update_document")+"...";
  var xhr = new XMLHttpRequest();
  var url = host+"/iSenhasAtualizarV4";
  if(development) url = host+"/iSenhasAtualizarV4DEV";
  xhr.open("POST", url, true);
...
function translate(){
    document.getElementById("loadinglabel").innerHTML = gettranslate("search_documents")+"...";
    document.getElementById("nametitle").innerHTML = gettranslate("name");
    document.getElementById("observationtitle").innerHTML = gettranslate("expiration_date");
    document.getElementById("descriptiontitle").innerHTML = gettranslate("description_title");
    document.getElementById("passwordtitle").innerHTML = gettranslate("identification_code");
    ...
    document.getElementById("search").placeholder = gettranslate("search_document");
    ...
    document.getElementById("title").innerHTML = gettranslate("documents");
    ...
    document.getElementById("addModalLabel").innerHTML = gettranslate("new_document");
    document.getElementById("nomeaddlabel").innerHTML = gettranslate("name");
    document.getElementById("senhaaddlabel").innerHTML = gettranslate("identification_code");
    document.getElementById("usuarioaddlabel").innerHTML = gettranslate("expiration_label");
    document.getElementById("nomeadd").placeholder = gettranslate("ex_doc_name");
    document.getElementById("senhaadd").placeholder = gettranslate("ex_doc_desc");
    document.getElementById("usuarioadd").placeholder = gettranslate("ex_doc_expiration");
    ...
    document.getElementById("excluirModalLabel").innerHTML = gettranslate("remove_documents");
    document.getElementById("removedesc").innerHTML = gettranslate("remove_documents_desc");
    ...
    document.getElementById("editModalLabel").innerHTML = gettranslate("edit_document");
    document.getElementById("nomeeditlabel").innerHTML = gettranslate("name");
    document.getElementById("senhaeditlabel").innerHTML = gettranslate("identification_code");
    document.getElementById("usuarioeditlabel").innerHTML = gettranslate("expiration_label");
    document.getElementById("nomeedit").placeholder = gettranslate("ex_doc_name");
    document.getElementById("senhaedit").placeholder = gettranslate("ex_note_desc");
    document.getElementById("usuarioedit").placeholder = gettranslate("ex_doc_expiration");
